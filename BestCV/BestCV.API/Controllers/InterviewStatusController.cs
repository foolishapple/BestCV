...
namespace BestCV.API.Controllers
{
    ...
    public class InterviewStatusController : BaseController
    {
        ...
        /// Description: list interview status
        /// </summary>
        /// <returns></returns>
        [HttpGet("list")]
        ...
        /// Author: NhatVi
        /// CreatedAt: 26/07/2023
        /// Description: detail interview status by id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("detail/{id}")]
        ...
        /// Author: NhatVi
        /// CreatedAt: 26/07/2023
        /// Description: insert interview status
        /// </summary>
        ...
        /// Author: NhatVi
        /// CreatedAt: 26/07/2023
        /// Description: delete interview status by id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpDelete("delete")]
