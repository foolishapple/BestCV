                ...
                success: function (response) {
                    ...
                    if (response.isSucceeded) {
                        Swal.fire(
                            ...
                            'Quản lý việc làm gấp <b>' + item.jobName + ' </b> đã được xóa thành công.',
                            'success'
                        );
                        reGenTable();
                    }
...
$("#tableData").on('click', '.order-section-change-up', function () {
    ...
    if (index != 0) {
        ...
        swal.fire({
            title: "Thay đổi thứ tự",
            html: "Việc làm gấp này đã ở vị trí đầu tiên, không thể thay đổi lên trên được",
            icon: 'info',
            confirmButtonColor: '#3085d6',
...
$("#tableData").on('click', '.order-section-change-down', function () {
    ...
    if (index != dataSource.length - 1) {
        ...
        swal.fire({
            title: "Thay đổi thứ tự",
            html: "Việc làm gấp này đã ở vị trí cuối cùng, không thể thay đổi xuống dưới được",
            icon: 'info',
            confirmButtonColor: '#3085d6',
            confirmButtonText: 'Đồng ý'
        })
