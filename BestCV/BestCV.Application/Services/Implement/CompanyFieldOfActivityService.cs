...
namespace BestCV.Application.Services.Implement
{
    public class CompanyFieldOfActivityService : ICompanyFieldOfActivityService
    {
        ...
        public async Task<BestCVResponse> CreateAsync(InsertCompanyFieldOfActivityDTO obj)
        {
        ...
        public async Task<BestCVResponse> CreateListAsync(IEnumerable<InsertCompanyFieldOfActivityDTO> objs)
        {
        ...
        public async Task<BestCVResponse> GetFieldActivityByCompanyId(int companyId)
        {
        ...
        public async Task<BestCVResponse> DeleteFieldActivityByCompanyId(int companyId)
        {
        ...
        public async Task<BestCVResponse> HardDeleteAsync(int id)
        {
            var item = await _repository.GetByIdAsync(id);
            if (item == null)
            {
        ...
        public async Task<BestCVResponse> UpdateAsync(UpdateCompanyFieldOfActivityDTO obj)
        {
        ...
        public async Task<BestCVResponse> UpdateListAsync(IEnumerable<UpdateCompanyFieldOfActivityDTO> obj)
        {
