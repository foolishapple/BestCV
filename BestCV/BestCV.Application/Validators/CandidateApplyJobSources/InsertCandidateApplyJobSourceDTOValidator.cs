...
{
    public class InsertCandidateApplyJobSourceDTOValidator : AbstractValidator<InsertCandidateApplyJobSourceDTO>
    {
        public InsertCandidateApplyJobSourceDTOValidator()
        {
