...
{
    public class InsertCandidateApplyJobStatusDTOValidator : AbstractValidator<InsertCandidateApplyJobStatusDTO>
    {
        public InsertCandidateApplyJobStatusDTOValidator()
        {
