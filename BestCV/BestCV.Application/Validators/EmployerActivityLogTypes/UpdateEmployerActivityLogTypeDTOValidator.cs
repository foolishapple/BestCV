...
{
    public class UpdateEmployerActivityLogTypeDTOValidator : AbstractValidator<UpdateEmployerActivityLogTypeDTO>
    {
        public UpdateEmployerActivityLogTypeDTOValidator()
        {
