...
namespace BestCV.Application.Validators.InterviewTypes
{
    public class UpdateInterviewTypeDTOValidator : AbstractValidator<UpdateInterviewTypeDTO>
    {
        public UpdateInterviewTypeDTOValidator()
        {
