...
{
    public class InsertMustInteresterdCompanyDTOValidator : AbstractValidator<InsertMustBeInterestedCompanyDTO>
    {
        public InsertMustInteresterdCompanyDTOValidator()
        {
