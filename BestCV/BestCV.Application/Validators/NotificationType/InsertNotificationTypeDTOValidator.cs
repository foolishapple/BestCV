...
namespace BestCV.Application.Validators.NotificationType
{
    public class InsertNotificationTypeDTOValidator : AbstractValidator<InsertNotificationTypeDTO>
    {
        public InsertNotificationTypeDTOValidator()
        {
            RuleFor(x => x.Name)
