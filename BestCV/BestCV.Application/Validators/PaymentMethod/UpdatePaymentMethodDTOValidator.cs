...
namespace BestCV.Application.Validators.PaymentMethod
{
    public class UpdatePaymentMethodDTOValidator : AbstractValidator<UpdatePaymentMethodDTO>
    {
        ...
        {
            RuleFor(x => x.Id)
                .NotNull().WithMessage("Mã phương thức thanh toán không được bỏ trống.")
                .GreaterThan(0).WithMessage("Mã phương thức thanh toán phải lớn hơn 0.");
            RuleFor(x => x.Name)
