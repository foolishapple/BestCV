...
namespace BestCV.Application.Validators.Position
{
    public class InsertPositionDTOValidator : AbstractValidator<InsertPositionDTO>
    {
        public InsertPositionDTOValidator() {
