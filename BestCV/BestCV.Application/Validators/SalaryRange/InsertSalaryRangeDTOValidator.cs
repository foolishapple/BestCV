...
namespace BestCV.Application.Validators.SalaryRange
{
    public class InsertSalaryRangeDTOValidator : AbstractValidator<InsertSalaryRangeDTO>
    {
        public InsertSalaryRangeDTOValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
