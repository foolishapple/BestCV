...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230727102939_delete_unique_key_Table_employerMeta")]
    partial class delete_unique_key_Table_employerMeta
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2606),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2687),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2707),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2745),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2819),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 29, 38, 937, DateTimeKind.Local).AddTicks(2779),
                            Name = "Nhân viên"
                        });
                });
