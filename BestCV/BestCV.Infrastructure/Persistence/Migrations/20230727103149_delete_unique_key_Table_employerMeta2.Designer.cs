...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230727103149_delete_unique_key_Table_employerMeta2")]
    partial class delete_unique_key_Table_employerMeta2
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(783),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(847),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(898),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(961),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(1074),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 27, 17, 31, 48, 383, DateTimeKind.Local).AddTicks(1014),
                            Name = "Nhân viên"
                        });
                });
