...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230731072920_add_column_EfficiencyTime_to_coupon_table")]
    partial class add_column_EfficiencyTime_to_coupon_table
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1138),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1172),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1189),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1271),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1329),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 7, 31, 14, 29, 19, 326, DateTimeKind.Local).AddTicks(1300),
                            Name = "Nhân viên"
                        });
                });
