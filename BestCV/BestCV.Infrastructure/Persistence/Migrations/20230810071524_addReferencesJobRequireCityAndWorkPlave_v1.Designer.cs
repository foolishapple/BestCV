...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230810071524_addReferencesJobRequireCityAndWorkPlave_v1")]
    partial class addReferencesJobRequireCityAndWorkPlave_v1
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(6994),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(7032),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(7053),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(7089),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(7136),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 14, 15, 20, 896, DateTimeKind.Local).AddTicks(7110),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Job", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.Employer", "Employer")
                        ...
                        .HasForeignKey("EmployerId")
                        .IsRequired()
                        .HasConstraintName("FK_Job_Employers");
