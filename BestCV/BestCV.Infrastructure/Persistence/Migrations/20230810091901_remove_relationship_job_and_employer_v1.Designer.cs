...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230810091901_remove_relationship_job_and_employer_v1")]
    partial class remove_relationship_job_and_employer_v1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(358),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(406),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(434),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(468),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(522),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 10, 16, 18, 57, 125, DateTimeKind.Local).AddTicks(488),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Job", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.Employer", null)
                        .WithMany("Jobs")
                        .HasForeignKey("EmployerId");
