...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230814163529_add_workplaceId_to_company")]
    partial class add_workplaceId_to_company
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8642),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8678),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8701),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8742),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8800),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 14, 23, 35, 29, 178, DateTimeKind.Local).AddTicks(8762),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasOne("Jobi.Domain.Entities.WorkPlace", null)
                        .WithMany("Companies")
                        .HasForeignKey("WorkPlaceId");
