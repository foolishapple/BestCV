...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230816071353_CreatedModuleCV")]
    partial class CreatedModuleCV
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9130),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9206),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9277),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9345),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CompanyShowOnHomePage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompanyShowOnHomePage", (string)null);
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9426),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.JobShowOnHomePage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JobShowOnHomePage", (string)null);
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 16, 14, 13, 48, 354, DateTimeKind.Local).AddTicks(9377),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateApplyJob", b =>
                {
                    ...
                    b.HasOne("Jobi.Domain.Entities.Candidate", "Candidate")
                        ...
                        .HasForeignKey("CandidateId")
                        .IsRequired()
                        .HasConstraintName("FK_CandidateApplyJobs_Candidate");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateCVPDF", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.CandidateCV", "CandidateCV")
                        .WithMany("CandidateCVPDFs")
                        .HasForeignKey("CandidateCvId")
                        .IsRequired()
                        .HasConstraintName("FK_CandidateCVPDF_CandidateCV");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CompanyShowOnHomePage", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.Company", "Company")
                        .WithOne("CompanyShowOnHomePage")
                        .HasForeignKey("Jobi.Domain.Entities.CompanyShowOnHomePage", "CompanyId")
                        .IsRequired()
                        .HasConstraintName("FK_CompanyShowOnHomePage_Company");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Employer", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.EmployerServicePackage", "EmployerServicePackage")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_Employer_EmployerServicePackage");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.JobShowOnHomePage", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.Job", "Job")
                        .WithOne("JobShowOnHomePage")
                        .HasForeignKey("Jobi.Domain.Entities.JobShowOnHomePage", "JobId")
                        .IsRequired()
                        .HasConstraintName("FK_JobShowOnHomePage_Job");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Company", b =>
                {
                    ...
                    b.Navigation("CompanyShowOnHomePage")
                        .IsRequired();
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Job", b =>
                {
                    ...
                    b.Navigation("JobShowOnHomePage")
                        .IsRequired();
                });
