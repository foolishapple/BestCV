...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230822074727_Add seed for CVTemplateStatus")]
    partial class AddseedforCVTemplateStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(2953),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3026),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3051),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3085),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3173),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3185),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3144),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 8, 22, 14, 47, 26, 98, DateTimeKind.Local).AddTicks(3116),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.TopFeatureJob", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.Job", "Job")
                        .WithOne("TopFeatureJobs")
                        .HasForeignKey("Jobi.Domain.Entities.TopFeatureJob", "JobId")
                        .IsRequired()
