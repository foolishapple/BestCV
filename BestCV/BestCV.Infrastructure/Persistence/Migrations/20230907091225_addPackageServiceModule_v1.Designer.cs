...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907091225_addPackageServiceModule_v1")]
    partial class addPackageServiceModule_v1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6171),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6226),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6261),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6301),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6364),
                            DiscountPrice = 0,
                            Name = "Thường",
                            Price = 0
                        });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 12, 20, 352, DateTimeKind.Local).AddTicks(6337),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Menu", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.MenuType", null)
                        .WithMany("Menus")
