...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907092002_addPackageServiceModule_v2")]
    partial class addPackageServiceModule_v2
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8286),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8352),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8387),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8428),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8491),
                            DiscountPrice = 0,
                            Name = "Thường",
                            Price = 0
                        });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 19, 57, 21, DateTimeKind.Local).AddTicks(8463),
                            Name = "Nhân viên"
                        });
                });
