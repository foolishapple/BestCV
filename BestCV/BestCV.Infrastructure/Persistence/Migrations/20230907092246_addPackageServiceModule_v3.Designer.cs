...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907092246_addPackageServiceModule_v3")]
    partial class addPackageServiceModule_v3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(3852),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(3931),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(3959),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(3997),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    ...
                    b.HasIndex("ServicePackageTypeId");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(4060),
                            DiscountPrice = 0,
                            Name = "Thường",
                            Price = 0
                        });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.JobAggreable", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 22, 41, 283, DateTimeKind.Local).AddTicks(4029),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerServicePackage", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.ServicePackageGroup", null)
                        .WithMany("EmployerServicePackages")
                        .HasForeignKey("ServicePackageGroupId");

                    b.HasOne("Jobi.Domain.Entities.ServicePackageType", null)
                        .WithMany("EmployerServicePackages")
                        .HasForeignKey("ServicePackageTypeId");
                });
