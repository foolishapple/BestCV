...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907093608_addPackageServiceModule_v4")]
    partial class addPackageServiceModule_v4
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 36, 2, 755, DateTimeKind.Local).AddTicks(7047),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 7, 16, 36, 2, 755, DateTimeKind.Local).AddTicks(7142),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 36, 2, 755, DateTimeKind.Local).AddTicks(7172),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 36, 2, 755, DateTimeKind.Local).AddTicks(7221),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 16, 36, 2, 755, DateTimeKind.Local).AddTicks(7261),
                            Name = "Nhân viên"
                        });
                });
