...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907111231_addPackageServiceModule_v7")]
    partial class addPackageServiceModule_v7
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 7, 18, 12, 26, 383, DateTimeKind.Local).AddTicks(6456),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 7, 18, 12, 26, 383, DateTimeKind.Local).AddTicks(6504),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 18, 12, 26, 383, DateTimeKind.Local).AddTicks(6531),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 18, 12, 26, 383, DateTimeKind.Local).AddTicks(6569),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 7, 18, 12, 26, 383, DateTimeKind.Local).AddTicks(6608),
                            Name = "Nhân viên"
                        });
                });
