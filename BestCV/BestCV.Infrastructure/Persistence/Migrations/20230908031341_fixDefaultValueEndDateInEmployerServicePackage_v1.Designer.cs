...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230908031341_fixDefaultValueEndDateInEmployerServicePackage_v1")]
    partial class fixDefaultValueEndDateInEmployerServicePackage_v1
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 8, 10, 13, 36, 822, DateTimeKind.Local).AddTicks(6234),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 8, 10, 13, 36, 822, DateTimeKind.Local).AddTicks(6278),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 8, 10, 13, 36, 822, DateTimeKind.Local).AddTicks(6302),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 8, 10, 13, 36, 822, DateTimeKind.Local).AddTicks(6341),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 8, 10, 13, 36, 822, DateTimeKind.Local).AddTicks(6370),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.TopFeatureJob", b =>
                {
                    ...
                    b.HasIndex("OrderSort", "SubOrderSort")
                        .IsUnique();
