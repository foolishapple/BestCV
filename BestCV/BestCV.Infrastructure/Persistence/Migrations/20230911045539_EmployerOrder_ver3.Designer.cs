...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230911045539_EmployerOrder_ver3")]
    partial class EmployerOrder_ver3
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 11, 11, 55, 37, 604, DateTimeKind.Local).AddTicks(1103),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 11, 11, 55, 37, 604, DateTimeKind.Local).AddTicks(1148),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 55, 37, 604, DateTimeKind.Local).AddTicks(1173),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 55, 37, 604, DateTimeKind.Local).AddTicks(1211),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 55, 37, 604, DateTimeKind.Local).AddTicks(1236),
                            Name = "Nhân viên"
                        });
                });
