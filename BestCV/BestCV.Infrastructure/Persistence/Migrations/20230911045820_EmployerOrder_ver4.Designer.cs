...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230911045820_EmployerOrder_ver4")]
    partial class EmployerOrder_ver4
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 11, 11, 58, 18, 82, DateTimeKind.Local).AddTicks(5693),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 11, 11, 58, 18, 82, DateTimeKind.Local).AddTicks(5753),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 58, 18, 82, DateTimeKind.Local).AddTicks(5787),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 58, 18, 82, DateTimeKind.Local).AddTicks(5835),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 11, 58, 18, 82, DateTimeKind.Local).AddTicks(5871),
                            Name = "Nhân viên"
                        });
                });
