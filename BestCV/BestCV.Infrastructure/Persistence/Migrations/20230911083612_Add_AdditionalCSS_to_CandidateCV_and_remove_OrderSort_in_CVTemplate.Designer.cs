...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230911083612_Add_AdditionalCSS_to_CandidateCV_and_remove_OrderSort_in_CVTemplate")]
    partial class Add_AdditionalCSS_to_CandidateCV_and_remove_OrderSort_in_CVTemplate
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8502),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8551),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8580),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8620),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8680),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8694),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 15, 36, 6, 681, DateTimeKind.Local).AddTicks(8652),
                            Name = "Nhân viên"
                        });
                });
