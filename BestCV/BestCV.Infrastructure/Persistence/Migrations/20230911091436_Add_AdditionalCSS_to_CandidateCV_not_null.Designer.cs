...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230911091436_Add_AdditionalCSS_to_CandidateCV_not_null")]
    partial class Add_AdditionalCSS_to_CandidateCV_not_null
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(2953),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3053),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3173),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3265),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3392),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3428),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 14, 31, 244, DateTimeKind.Local).AddTicks(3320),
                            Name = "Nhân viên"
                        });
                });
