...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230911092228_edit_OrderSort_not_null_CVTemplate")]
    partial class edit_OrderSort_not_null_CVTemplate
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1443),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1502),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1622),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1683),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1762),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1782),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 11, 16, 22, 22, 676, DateTimeKind.Local).AddTicks(1718),
                            Name = "Nhân viên"
                        });
                });
