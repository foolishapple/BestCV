...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230913033353_CreateDatbaseToEmployerCart_v1")]
    partial class CreateDatbaseToEmployerCart_v1
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(1926),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(1965),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(1990),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(2028),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(2086),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(2098),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 13, 10, 33, 48, 754, DateTimeKind.Local).AddTicks(2054),
                            Name = "Nhân viên"
                        });
                });
