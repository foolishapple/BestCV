...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230919114724_Edit_CandidateCV_TemplateCVId_allow_null")]
    partial class Edit_CandidateCV_TemplateCVId_allow_null
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1103),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1228),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1262),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1309),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1382),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1399),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 18, 47, 18, 882, DateTimeKind.Local).AddTicks(1348),
                            Name = "Nhân viên"
                        });
                });
