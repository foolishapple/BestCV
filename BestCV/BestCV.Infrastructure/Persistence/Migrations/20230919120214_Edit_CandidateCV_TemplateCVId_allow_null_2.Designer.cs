...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230919120214_Edit_CandidateCV_TemplateCVId_allow_null_2")]
    partial class Edit_CandidateCV_TemplateCVId_allow_null_2
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(4692),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(4917),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(5016),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(5102),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(5207),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(5231),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 19, 19, 2, 9, 122, DateTimeKind.Local).AddTicks(5150),
                            Name = "Nhân viên"
                        });
                });
