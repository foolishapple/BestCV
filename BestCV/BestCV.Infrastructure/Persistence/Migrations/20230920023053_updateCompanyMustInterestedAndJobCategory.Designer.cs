...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230920023053_updateCompanyMustInterestedAndJobCategory")]
    partial class updateCompanyMustInterestedAndJobCategory
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6381),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6434),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6456),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6485),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6528),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6539),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 9, 30, 49, 200, DateTimeKind.Local).AddTicks(6506),
                            Name = "Nhân viên"
                        });
                });
