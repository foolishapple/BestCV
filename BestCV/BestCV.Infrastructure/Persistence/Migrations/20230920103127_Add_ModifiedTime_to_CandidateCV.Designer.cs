...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230920103127_Add_ModifiedTime_to_CandidateCV")]
    partial class Add_ModifiedTime_to_CandidateCV
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7400),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7488),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7560),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7625),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7708),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7725),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 20, 17, 31, 22, 39, DateTimeKind.Local).AddTicks(7669),
                            Name = "Nhân viên"
                        });
                });
