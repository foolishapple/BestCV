...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230926034749_AddPaymentHistoryToWallet_v1")]
    partial class AddPaymentHistoryToWallet_v1
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7647),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7738),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7764),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7803),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7875),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7887),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 26, 10, 47, 45, 88, DateTimeKind.Local).AddTicks(7845),
                            Name = "Nhân viên"
                        });
                });
