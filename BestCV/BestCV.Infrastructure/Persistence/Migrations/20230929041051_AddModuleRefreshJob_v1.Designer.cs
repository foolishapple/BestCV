...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230929041051_AddModuleRefreshJob_v1")]
    partial class AddModuleRefreshJob_v1
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(965),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1010),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1042),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1078),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1142),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1159),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerWalletHistory", b =>
                {
                    ...
                    b.Property<long>("EmploEmployerWalletId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("EmploEmployerWalletId");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 9, 29, 11, 10, 46, 259, DateTimeKind.Local).AddTicks(1108),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.EmployerWalletHistory", b =>
                {
                    b.HasOne("Jobi.Domain.Entities.EmployerWallet", "EmployerWallet")
                        ...
                        .HasForeignKey("EmploEmployerWalletId")
                        .IsRequired()
