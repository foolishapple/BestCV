...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231001135651_updateEmployerWalletHistory_v2")]
    partial class updateEmployerWalletHistory_v2
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8388),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8429),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8451),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8485),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8544),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8551),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 1, 20, 56, 50, 467, DateTimeKind.Local).AddTicks(8512),
                            Name = "Nhân viên"
                        });
                });
