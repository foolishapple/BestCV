...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231003071532_AddIsApprovedToEmployerWalletHistory")]
    partial class AddIsApprovedToEmployerWalletHistory
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(6919),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(6950),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(6974),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(7036),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(7101),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(7108),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 15, 27, 851, DateTimeKind.Local).AddTicks(7070),
                            Name = "Nhân viên"
                        });
                });
