...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231003073108_AddUpdatedTimeToEmployerWalletHistory")]
    partial class AddUpdatedTimeToEmployerWalletHistory
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4670),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4711),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4761),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4810),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4873),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4882),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 3, 14, 31, 4, 212, DateTimeKind.Local).AddTicks(4839),
                            Name = "Nhân viên"
                        });
                });
