...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231011095419_edit_description_candidateWorkExperience")]
    partial class edit_description_candidateWorkExperience
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1173),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1242),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1273),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1311),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1378),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1390),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.JobSecondaryJobPosition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 11, 16, 54, 17, 611, DateTimeKind.Local).AddTicks(1349),
                            Name = "Nhân viên"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasOne("Jobi.Domain.Entities.JobPosition", "PrimaryJobPosition")
                        .WithMany("Jobs")
