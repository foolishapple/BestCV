...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231023031259_remove_employer_skype_unique")]
    partial class remove_employer_skype_unique
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5746),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5833),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5865),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5903),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5967),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5981),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 23, 10, 12, 58, 174, DateTimeKind.Local).AddTicks(5933),
                            Name = "Nhân viên"
                        });
                });
