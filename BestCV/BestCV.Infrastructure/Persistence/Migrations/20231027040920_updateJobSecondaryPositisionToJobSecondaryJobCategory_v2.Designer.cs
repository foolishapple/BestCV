...
namespace Jobi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231027040920_updateJobSecondaryPositisionToJobSecondaryJobCategory_v2")]
    partial class updateJobSecondaryPositisionToJobSecondaryJobCategory_v2
    {
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AccountStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Color = "green",
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8828),
                            Name = "Active"
                        },
                        new
                        {
                            ...
                            Active = true,
                            Color = "red",
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8871),
                            Name = "Block"
                        });
                });
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.AdminAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8897),
                            Email = "dion@info.vn",
                            FullName = "admin",
                            LockEnabled = false,
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CandidateLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8933),
                            DiscountPrice = 0,
                            ExpiryTime = 0,
                            Name = "Thường",
                            Price = 0
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.CVTemplateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8992),
                        ...
                        new
                        {
                            Id = 1002L,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(9002),
            ...
            modelBuilder.Entity("Jobi.Domain.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            Active = true,
                            CreatedTime = new DateTime(2023, 10, 27, 11, 9, 15, 263, DateTimeKind.Local).AddTicks(8964),
                            Name = "Nhân viên"
                        });
                });
