...
namespace Jobi.Web.Controllers
{
    public class CVController : BaseController
    {
        ...
        /// Description: Trang quản lý CV PDF
        /// </summary>
        /// <returns></returns>
        ...
        /// Description: View Demo Print PDF
        /// </summary>
        ...
        /// Description: View xem trước khi in
        /// </summary>
        ...
        /// Description: Hàm in CV
        /// </summary>
        /// <param name="candidateCVDTO"></param>
        /// <returns></returns>
        [Route("print-to-pdf")]
