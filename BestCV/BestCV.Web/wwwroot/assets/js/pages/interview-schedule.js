var calendar;
var yourTimezone = 'Asia/Ho_Chi_Minh';
var listEvents = [];
...
function initCalendar() {
    calendar = new FullCalendar.Calendar($("#calendar")[0], {
        ...
        eventClick: function (info) {
            ...
            } else if (info.event.extendedProps.eventStatusId == NOT_YET) {
...
function loadListEvent() {
    ...
    $.ajax({
        url: systemConfig.defaultAPIURL + "api/interview-schedule/getListInterviewByCandiddateId",
        type: "GET",
        async: true,
