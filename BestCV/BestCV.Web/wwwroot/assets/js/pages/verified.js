 ...
 * author: truongthieuhuyen
 * created: 04.08.2023
 * @description xác thực cặp key trong bảng meta
 */
async function verifyEmail() {

    try {
        let result = await httpService.putAsync('api/candidate/verify-email-code', data);
...
$('#pxp-re-send-email').on('click', function () {
    ...
    $.ajax({
        url: systemConfig.defaultAPIURL + 'api/candidate/re-send-email',
        type: "POST",
...
//    $.ajax({
//        url: 'https://localhost:7059/api/candidate/re-send-email',
//        type: "POST",
//        contentType: "application/json",
//        data: JSON.stringify(obj),
//        success: function (res) {
