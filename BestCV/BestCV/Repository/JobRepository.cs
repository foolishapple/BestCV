...
using Jobi.Domain.Aggregates.ExperienceRange;
using Jobi.Domain.Aggregates.Job;
using Jobi.Domain.Aggregates.JobReasonsApply;
using Jobi.Domain.Aggregates.JobRequireCity;
using Jobi.Domain.Aggregates.JobRequireJobSkill;
using Jobi.Domain.Aggregates.JobRequireSkill;
using Jobi.Domain.Aggregates.JobSecondaryPosition;
using Jobi.Domain.Aggregates.JobTag;
using Jobi.Domain.Aggregates.JobType;
using Jobi.Domain.Aggregates.Position;
using Jobi.Domain.Aggregates.SalaryRange;
