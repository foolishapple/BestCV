...
namespace Jobi.Infrastructure.Persistence
{
    public class JobiContext : DbContext
    {
        ...
        //        //SERVER TEST: Data Source=103.214.9.237;Initial Catalog=Dion.Jobi;User ID=Jobi.Dev;Password=AjUxDXnz6JBZfiI
        //        optionsBuilder.UseSqlServer(@"Data Source=103.214.9.237;Initial Catalog=Dion.Jobi;User ID=Jobi.Dev;Password=AjUxDXnz6JBZfiI");
        //    }
