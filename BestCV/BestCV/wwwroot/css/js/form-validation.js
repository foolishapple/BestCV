...
class FormValidation {
    ...
    checkMinLength(element, validLength, allowNullOrEmpty = false) {
        if (element && validLength && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || Array.isArray(value) ? value.length >= validLength : value !== null && value.trim().length >= validLength;
        }
        return false;
    }
    ...
    checkRangeLength(element, minLength, maxLength, allowNullOrEmpty = false) {
        if (element && minLength && maxLength && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || (minLength <= length && length <= maxLength);
        }
        return false;
    }
    ...
    checkMin(element, min, allowNullOrEmpty = false) {
        if (element && min && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || false;
        }
        return false;
    }
    ...
    checkMax(element, max, allowNullOrEmpty = false) {
        if (element && max && $(element).length > 0) {
            let value = parseFloat($(element).val());
            if (value) {
                return (allowNullOrEmpty && !$(element).val()) || value <= max;
            }
            return (allowNullOrEmpty && !$(element).val()) || false;
        }
        return false;
    ...
    checkRange(element, min, max, allowNullOrEmpty = false) {
        if (element && min && max && $(element).length > 0) {
            let value = parseFloat($(element).val());
            if (value) {
                return (allowNullOrEmpty && !$(element).val()) || (min <= value && value <= max);
            }
            return (allowNullOrEmpty && !$(element).val()) || false;
        }
        return false;
    ...
    checkEmail(element, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && $(element).val().trim().match(mailformat));
        }
        return false;
    }
    ...
    checkUrl(element, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && $(element).val().trim().match(httpRegex));
        }
        return false;
    }
    ...
    checkPhone(element, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && $(element).val().trim().match(regexPhoneNumber));
        }
        return false;
    }
    ...
    checkDate(element, format, allowNullOrEmpty = false) {
        if (element && format && $(element).length > 0) {
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && moment($(element).val().trim(), format).isValid());
        }
        return false;
    }
    ...
    checkNumber(element, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            return (allowNullOrEmpty && !$(element).val()) || !isNaN(parseFloat($(element).val().trim()))
        }
        return false;
    }
    ...
    checkDigits(element, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            const digitRex = /^\d+$/;
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && $(element).val().trim().match(digitRex));
        }
        return false;
    }
    ...
    checkCustomRegex(element, regexExpression, allowNullOrEmpty = false) {
        if (element && $(element).length > 0) {
            ...
            return (allowNullOrEmpty && !$(element).val()) || ($(element).val() !== null && regex.test($(element).val().trim()))
        }
        return false;
    }
}
